...
public class MyRouteActivity extends AppCompatActivity implements ObservableScrollViewCallbacks{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_route);
        this.setTitle("My Route");
        ...
        final myItem_adapter adapter;

        // Adapter
        adapter = new myItem_adapter() ;

        // list view reference and Adapter putting
        listView = (ObservableListView) findViewById(R.id.my_review_list);
        listView.setScrollViewCallbacks(this);
        listView.setAdapter(adapter);

        // adding first item
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.selectedroute),
                "Grizzly Express", "so good!","10m 31s") ;
        // second item
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.selectedroute),
